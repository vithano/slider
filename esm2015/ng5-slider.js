...
class SliderComponent {
    ...
    updateLowHandle(newPos) {
        ...
        var /** @type {?} */ pos = this.getHandleLabelPos(PointerType.Min, newPos);
        if (this.viewOptions.fixLabelToCenter === true) {
            var /** @type {?} */ handleDimension = Math.floor(this.minHandleLabelElement.dimension / 16);
    ...
    updateHighHandle(newPos) {
        ...
        var /** @type {?} */ pos = this.getHandleLabelPos(PointerType.Max, newPos);
        if (this.viewOptions.fixLabelToCenter === true) {
            var /** @type {?} */ handleDimension = Math.floor(this.maxHandleLabelElement.dimension / 16);
            pos = Math.ceil(Math.ceil(this.maxHandlePosition / 2) - handleDimension * 3 - 1);
        }
